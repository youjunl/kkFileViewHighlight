...
<script type="text/javascript">
    ...
    document.getElementsByTagName('iframe')[0].src = "${baseUrl}pdfExt/web/viewer.html?file=" + encodeURIComponent(url)+ "&keyword="+ encodeURIComponent(keyword) + "&pageNum="+ encodeURIComponent(pageNum);
