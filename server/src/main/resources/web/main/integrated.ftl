...
<div class="container theme-showcase" role="main">
    ...
    <div class="well">
        <div style="font-size: 16px; color: red">
            【关键词高亮定位】对于 doc、docx、pdf、excel、txt 等格式文件，支持关键词高亮定位功能。在预览 url 后面添加 keyword 参数即可，多个关键词用空格分隔：
            <p style="background-color: #2f332a;color: #cccccc;font-size: 14px;padding:10px;margin-top:10px;">
                ...
                var keyword = '关键词1 关键词2 关键词3'; //多个关键词用空格分隔 <br>
                window.open('http://127.0.0.1:8012/onlinePreview?url='+encodeURIComponent(Base64.encode(url))+'&keyword='+encodeURIComponent(keyword));
            </p>
        </div>
        <br>
