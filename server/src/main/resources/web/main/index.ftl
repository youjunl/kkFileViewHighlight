...
<div class="container theme-showcase" role="main">
    ...
    <div>
        ...
        <div class="collapse" id="fileTypeList">
            <ol>
    ...
    <div class="panel panel-success">
        <div class="panel-heading">
            <h3 class="panel-title">输入在线文件地址进行预览</h3>
        </div>
        <div class="panel-body">
            <form>
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            <input type="text" class="form-control" id="_keyword" placeholder="请输入需要高亮定位的关键词（多个关键词用空格分隔）">
                        </div>
                    </div>
                    <div class="col-md-2">
...
<script>
    ...
    $(function () {
        ...
        $('#previewByUrl').on('click', function () {
            ...
            var keywordParam = keyword ? '&keyword=' + encodeURIComponent(keyword) : '';

            window.open('${baseUrl}onlinePreview?url=' + encodeURIComponent(b64Encoded) + keywordParam);
        });
